<?php echo anchor('admincp/restaurantchain/add', 'Add Restaurant Chain'); ?><br /><br />

<script src="<?php echo base_url()?>js/jquery.colorize.js" type="text/javascript"></script>
<script src="<?php echo base_url()?>js/admin/chain_search_admin.js" type="text/javascript"></script>
