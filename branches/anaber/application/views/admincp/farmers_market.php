<?php echo anchor('admincp/farmersmarket/add', 'Add Farmers Market'); ?><br /><br />

<script src="<?php echo base_url()?>js/jquery.colorize.js" type="text/javascript"></script>
<script src="<?php echo base_url()?>js/admin/farmers_market_search_admin.js" type="text/javascript"></script>
