...
<table class="formTable">
	<tr>
		...
		<td width = "75%">
			<input value="<?php echo (isset($RESTAURANTTYPE) ? $RESTAURANTTYPE->restauranttypeName : '') ?>" class="validate[required]" type="text" name="restauranttypeName" id="restauranttypeName"/><br />
		</td>
	<tr>
	<tr>
