...
<div id="rbox">
	...
	<div id = "divZipcode"><form id = "frmFilters">Zip Code <input type="text" size="6" maxlength="5" id = "q"></form></div><br>

	<strong>Restaurant Type</strong><br>
	<div id = "divRestaurantTypes"></div>
	
		
	<br><strong>Cuisine</strong><br>
	<div id = "divCuisines"></div>
