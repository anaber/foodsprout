...
<div id="product_details_header" >
	...
	<div id="iAteThisBtn"><a href="<?php echo base_url(); ?>product/eaten/<?php echo $productDetails->product_id; ?>/?height=400&width=400" style="float: right;" class="thickbox" title="">I ate this</a></div>
