...
<div id="lottery">
	...
	<h2>This week enter to dine at <?php echo $LOTTRIES['results'][$currentIndex]->producer; ?> and sample their sustainable food.</h2>
...
?>
			...
			<div class="prizedate">
				...
				<?php
					...
					if ($prizeCount > 0) {
				?>
					<div class="prize">Prizes: Free Gift Certificate of worth 
				<?php
						$i = 0;
	...
	<div>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="15%" class="deals_head">Expire on</td>
		...
		?>
			<tr>
				...
				<td valign="top" class="deal_firstrow"><a href="/restaurant/view/<?php echo $lottery->producerId; ?>"><?php echo $lottery->producer; ?></a></td>
				<td valign="top" class="deal_firstrow"><?php echo $lottery->city . ', ' . $lottery->stateCode; ?></td>
				<td valign="top" class="deal_firstrow black">
				<?php
					$j = 0;
				...
				<td valign="top" class="deal_firstrow"><?php echo $lottery->endDate; ?></td>
				<td valign="top" class="deal_firstrow"><div class="flt"><a title="click here to grab it" href="/tab?id=<?php echo $lottery->lotteryId; ?>" class="button_img"><span>Grab it</span></a></div></td>
			</tr>
		<?php
				}
				$i++;
