...
<script src="<?php echo base_url()?>js/info/distributor_info.js" type="text/javascript"></script>
...
<script>
	...
	$(document).ready(function() {
		...
		if(window.location.hash) {
			...
			if (tab == 'supplier') {
				$.post("/distributor/ajaxSearchDistributorSuppliers", { q: distributorId, addressId:addressId, producerUrl:uri },
				...
				$.post("/distributor/ajaxSearchDistributorMenus", { q: distributorId, addressId:addressId, producerUrl:uri },
				...
				$.post("/distributor/ajaxSearchDistributorComments", { q: distributorId, addressId:addressId, producerUrl:uri },
				...
				$.post("/distributor/ajaxSearchDistributorPhotos", { q: distributorId, addressId:addressId, producerUrl:uri },
		...
		$.post("/distributor/ajaxSearchDistributorInfo", { distributorId:"<?php echo (isset($DISTRIBUTOR) ? $DISTRIBUTOR->distributorId : ''); ?>", addressId:"<?php echo (isset($ADDRESS_ID) ? $ADDRESS_ID : '' ); ?>" },
		function(data){
			if (data.geocode != '') {
