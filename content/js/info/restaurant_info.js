...
function postAndRedrawContent(page, perPage, s, o, query, filter, type) {
	...
	if (type == 'menu') {
		...
		formAction = '/restaurant/ajaxSearchRestaurantPhotos';
	}
	
	postArray = { p:page, pp:perPage, sort:s, order:o, q:restaurantId, f:filter, addressId:addressId, producerUrl:uri };
