...
function addResult(restaurantChain, count) {
	...
	html +=
		'	<div style="padding:5px;"><a href="/restaurantchain/view/' + restaurantChain.restaurantChainId + '" id = "'+ restaurantChain.restaurantChainId +'">'+ restaurantChain.restaurantChain + '</a></div>';
