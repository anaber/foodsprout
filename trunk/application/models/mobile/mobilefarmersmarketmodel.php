<?php
class MobileFarmersMarketModel extends Model{
	
	
	function getFarmersMarketByCoordinates($latitude = '', $longitude = '', $distance = ''){
	...
	function getFarmersMarketByZipCode($zipcode='', $distance =''){
	...
	function getFarmersMarketByCity($cityId = ''){
