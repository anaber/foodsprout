<div id="mainarea">
	<ul id="menu">
		...
		<li>	
			<form method="post" name="findCity" action="<?php echo base_url()?>mobile/farms/bycity/">
				<label>City </label>
		...
		<li>
			...
			<?php
				foreach($cities as $city){
					...
					echo '<span><a href="'.base_url().'mobile/farms/by_city/'.$city['city_id'].'" >'.$city['city'].'</a></span><br />';
