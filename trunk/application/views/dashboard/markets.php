...
<script>
	...
	$(document).ready(function() {
		...
		$.post("/user/ajaxFarmersMarketsByUser", { q: userId },
		function(data){
			currentContent = 'farmers_market';
			jsonData = data;
			redrawContent(data, 'farmers_market');
		},
		"json");
	});
...
<!-- center tabs -->
	...
	<div>
		<div style="float:left;width:530px;"><h1>My Markets</h1></div>
		<div class="clear"></div>
		<hr size="1">
		<div class="clear"></div>
	</div>
