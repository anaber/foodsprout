	...
	<ul id="jsddm">
		...
		<li><a href="#">Food Producers</a>
			<ul>
				...
				<li><?php echo anchor('admincp/alliance', 'Alliance'); ?></li>
				<li><a>---------------</a></li>
				<li><?php echo anchor('admincp/company', 'Conglomerates'); ?></li>
				<li><?php echo anchor('admincp/producergroup', 'Producer Groups'); ?></li>
				<li><a>---------------</a></li>
				<li><?php echo anchor('admincp/noaddress', 'No Address'); ?></li>
			</ul>
		</li>
		...
		<li><a href="#">Control</a>
			<ul>
			    ...
			    <li><?php echo anchor('admincp/newsfeed', 'News Feed'); ?></li>
			</ul>
		</li>
		<li><a href="#">Users</a>
			<ul>
