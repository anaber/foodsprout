<?php echo anchor('admincp/producergroup/add_group', 'Add Group'); ?><br /><br />

<script src="<?php echo base_url()?>js/jquery.colorize.js" type="text/javascript"></script>
<script src="<?php echo base_url()?>js/admin/producergroup_search_admin.js" type="text/javascript"></script>
